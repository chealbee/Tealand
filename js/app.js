(() => {
  ...
  (() => {
    ...
    function spollers() {
      ...
      if (spollersArray.length > 0) {
        ...
        function hideSpollersBody(spollersBlock) {
          const spollerActiveBlock =
            spollersBlock.querySelector("details[open]");
          if (
            spollerActiveBlock &&
    ...
    function initSliders() {
      ...
      if (document.querySelector(".best-menu__slider"))
        new swiper_core_Swiper(".best-menu__slider", {
      ...
      if (document.querySelector(".peculiarities__slider"))
        new swiper_core_Swiper(".peculiarities__slider", {
          modules: [Autoplay, EffectFade],
          observer: true,
          observeParents: true,
          slidesPerView: 1,
      ...
      if (document.querySelector(".unique-items__slider"))
        new swiper_core_Swiper(".unique-items__slider", {
